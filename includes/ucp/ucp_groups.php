		...
		switch ($mode)
		{
			case 'membership':
				...
				if ($submit || isset($_POST['change_default']))
				{
					...
					{
						$row['group_name'] = ($row['group_type'] == GROUP_SPECIAL) || @$user->lang['G_' . $row['group_name']] ? $user->lang['G_' . $row['group_name']] : $row['group_name'];
			...
			case 'manage':
				...
				switch ($action)
				{
					...
					case 'default':
						...
						$group_row['group_name'] = ($group_row['group_type'] == GROUP_SPECIAL) || @$user->lang['G_' . $group_row['group_name']] ? $user->lang['G_' . $group_row['group_name']] : $group_row['group_name'];
					...
					default:
						...
						{
							$template->assign_block_vars('leader', array(
								'GROUP_NAME'	=> ($value['group_type'] == GROUP_SPECIAL) || @$user->lang['G_' . $value['group_name']] ? $user->lang['G_' . $value['group_name']] : $value['group_name'],
