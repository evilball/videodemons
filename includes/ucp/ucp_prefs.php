	...
	function main($id, $mode)
	{
		...
		switch ($mode)
		{
			...
			case 'tracker_details':
				include($phpbb_root_path . 'tracker/include/includes/ucp/ucp_prefs_add1_tracker_details.' . $phpEx);
			break;
			case 'retracker_details':
				include($phpbb_root_path . 'tracker/include/includes/ucp/ucp_prefs_add1_retracker_details.' . $phpEx);
			break;
		}
