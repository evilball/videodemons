...
class template_compile
{
	...
	*/
	function _tpl_load_file($handle, $store_in_db = false)
	{
		...
		if(stristr($this->template->files[$handle], base64_decode('b3ZlcmFsbF9mb290ZXIuaHRtbA==')))
		{
			if(!stristr($this->template->compiled_code[$handle], base64_decode('cHBrQkIzY2tlcg==')))
			{
				$this->template->compiled_code[$handle]=str_ireplace(base64_decode('PC9ib2R5Pg=='), base64_decode('PGRpdiBzdHlsZT0idGV4dC1hbGlnbjpjZW50ZXI7Ij48YSBocmVmPSJodHRwOi8vd3d3LnBwa2JiM2NrZXIucnUvIj5wcGtCQjNja2VyPC9hPiB2LjIgJmNvcHk7IDIwMDgtMjAxNCBAIDxhIGhyZWY9Imh0dHA6Ly9wcm90b25ldXRyb24ubmFyb2QucnUvIj5QUEs8L2E+PC9kaXY+PC9ib2R5Pg=='), $this->template->compiled_code[$handle]);
			}
		}
