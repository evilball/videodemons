...
function group_create(&$group_id, $type, $name, $desc, $group_attributes, $allow_desc_bbcode = false, $allow_desc_urls = false, $allow_desc_smilies = false)
{
	...
	if (!sizeof($error))
	{
		...
		$name = ($type == GROUP_SPECIAL) || @$user->lang['G_' . $name] ? $user->lang['G_' . $name] : $name;
...
function get_group_name($group_id)
{
	...
	return ($row['group_type'] == GROUP_SPECIAL) || @$user->lang['G_' . $row['group_name']] ? $user->lang['G_' . $row['group_name']] : $row['group_name'];
}
