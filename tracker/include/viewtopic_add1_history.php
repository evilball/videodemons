...
*
* @package ppkBB3cker
* @version $Id: viewtopic_add1_history.php 1.000 2009-02-07 11:30:00 PPK $
...
$sql='SELECT s.*, u.username, u.user_id, u.user_colour FROM '. TRACKER_SNATCHED_TABLE ." s LEFT JOIN ". USERS_TABLE ." u ON (s.userid=u.user_id) WHERE s.torrent='{$torrent_id}'".($mua_limit ? " LIMIT {$mua_limit}" : '');// ORDER BY $sql_addon";
