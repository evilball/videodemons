...
$lang = array_merge($lang, array(
	...
	'PPK_TRACKER'					=> 'Трекер',
	'PPK_CHAT'					=> 'Чат',
	'TRACKER_ANNOUNCE_URL'				=> 'Анонс URL трекера: %s',
	...
	'MESS_WITHOUT_TORRENT'			=> 'Не загружен файл торрента',
	'MESS_TOOMANY_TORRENTS'			=> 'Слишком много торрент файлов',
	'MESS_TOOMANY_POSTERS'			=> 'Слишком много постеров',
	'MESS_TOOMANY_SCREENSHOTS'			=> 'Слишком много скриншотов',
	'MESS_TOOMANY2_TORRENTS'			=> 'Слишком мало торрент файлов',
	'MESS_TOOMANY2_POSTERS'			=> 'Слишком мало постеров',
	'MESS_TOOMANY2_SCREENSHOTS'			=> 'Слишком мало скриншотов',
	...
	'FORM_TORRENT_FREE'	=> 'Скачанное не учитывается на %s%s',
	'TORRENT_FREE'	=> 'Скачанное не учитывается на',
	'TORRENT_REQRATIO'	=> 'Для скачивания необходимо ратио не меньше',
	'TORRENT_REQUPLOAD'	=> 'Для скачивания необходим аплоад не меньше',
	'TORRENT_WAIT'	=> 'Для скачивания торрента необходимо подождать %s часа(ов)',
	'TORRENT_BONUS'	=> 'За каждые %s. аплоада (сидирования) этого торрента начисляется бонус: %s',
	'TORRENT_REQ_UPLOAD_0' => 'Ограничения по аплоаду, вы можете скачать этот торрент, необходимый аплоад: %s (Ваш: %s)',
	'TORRENT_REQ_UPLOAD_1' => 'Ограничения по аплоаду, вы НЕ можете скачать этот торрент, необходимый аплоад: %s (Ваш: %s)',
	'TORRENT_REQ_RATIO_0' => 'Ограничения по ратио, вы можете скачать этот торрент, необходимое ратио: %s (Ваше: %s)',
	'TORRENT_REQ_RATIO_1' => 'Ограничения по ратио, вы НЕ можете скачать этот торрент, необходимое ратио: %s (Ваше: %s)',
	...
	'TORRENT_INFO_HEADER_THANKS'		=> 'Кто благодарил',
	...
	'TOTAL_TORRENT_ZERO'	=> 'Торрентов: <strong>0</strong>',
	'TOTAL_TORRENT_OTHER'	=> 'Торрентов: <strong>%d</strong>',
	'TOTAL_COMMENT_ZERO'	=> 'Комментариев: <strong>0</strong>',
	'TOTAL_COMMENT_OTHER'	=> 'Комментариев: <strong>%d</strong>',
	...
	'TOTAL_PEER_ZERO'	=> 'Пиров: <strong>0</strong>',
	'TOTAL_PEER_OTHER'	=> 'Пиров: <strong>%d</strong>',
	...
	'TOTAL_SEED_ZERO'	=> 'Раздающих: <strong>0</strong>',
	'TOTAL_SEED_OTHER'	=> 'Раздающих: <strong>%d</strong>',
	'TOTAL_LEECH_ZERO'	=> 'Скачивающих: <strong>0</strong>',
	'TOTAL_LEECH_OTHER'	=> 'Скачивающих: <strong>%d</strong>',
	'TOTAL_SIZE_ZERO'	=> 'Общий размер торрентов: <strong>0</strong>',
	'TOTAL_SIZE_OTHER'	=> 'Общий размер торрентов: <strong>%s</strong>',
	'TOTAL_UP_ZERO'		=> 'Всего роздано: <strong>0</strong>',
	'TOTAL_UP_OTHER'	=> 'Всего роздано: <strong>%s</strong>',
	'TOTAL_DOWN_ZERO'	=> 'Всего скачано: <strong>0</strong>',
	'TOTAL_DOWN_OTHER'	=> 'Всего скачано: <strong>%s</strong>',
	'TOTAL_SUP_ZERO'	=> 'Роздано за сессию: <strong>0</strong>',
	'TOTAL_SUP_OTHER'	=> 'Роздано за сессию: <strong>%s</strong>',
	'TOTAL_SDOWN_ZERO'	=> 'Скачано за сессию: <strong>0</strong>',
	'TOTAL_SDOWN_OTHER'	=> 'Скачано за сессию: <strong>%s</strong>',
	'TOTAL_TDOWN_ZERO'	=> 'Раздаваемых торрентов: <strong>0</strong>',
	'TOTAL_TDOWN_OTHER'	=> 'Раздаваемых торрентов: <strong>%s</strong>',
	'TOTAL_TUP_ZERO'	=> 'Скачиваемых торрентов: <strong>0</strong>',
	'TOTAL_TUP_OTHER'	=> 'Скачиваемых торрентов: <strong>%s</strong>',
	'TOTAL_UDOWN_ZERO'	=> 'Раздающих пользователей: <strong>0</strong>',
	'TOTAL_UDOWN_OTHER'	=> 'Раздающих пользователей: <strong>%s</strong>',
	'TOTAL_UUP_ZERO'	=> 'Скачивающих пользователей: <strong>0</strong>',
	'TOTAL_UUP_OTHER'	=> 'Скачивающих пользователей: <strong>%s</strong>',
	'TOTAL_SPEEDDOWN_ZERO'	=> 'Суммарная скорость скачивания: <strong>0 байт</strong>',
	'TOTAL_SPEEDDOWN_OTHER'	=> 'Суммарная скорость скачивания: <strong>%s</strong>',
	'TOTAL_SPEEDUP_ZERO'	=> 'Суммарная скорость раздачи: <strong>0 байт</strong>',
	'TOTAL_SPEEDUP_OTHER'	=> 'Суммарная скорость раздачи: <strong>%s</strong>',
	'TOTAL_THANKS_ZERO'	=> 'Общее количество спасибо: <strong>0</strong>',
	'TOTAL_THANKS_OTHER'	=> 'Общее количество спасибо: <strong>%s</strong>',
	'PB'					=> 'ПБ',
	'PIB'					=> 'ПБ',
	'EB'					=> 'ЭБ',
	'EIB'					=> 'ЭБ',
	...
	'FORM_TORRENT_FORB' 			=> 'Данный торрент является блокированным, причина: %s',

	'IN_CHAT'				=> 'В чате',

	'TRACKER_USER_REALDOWNLOAD' => 'Скачал в действительности',

	'TRACKER_USER_UPLOAD_SELF' => 'Раздал на своих торрентах',
	'TRACKER_USER_RRATIO' => 'Ратио в действительности',
	'TRACKER_USER_SEEDS' => 'Раздаваемых торрентов',
	'TRACKER_USER_LEECHS' => 'Скачиваемых торрентов',
	'TRACKER_USER_BONUS' => 'Бонус',
	'TRACKER_USER_BONUS1' => 'Бонус за аплоад',

	'TRACKER_USER_TORRENTS' => 'Торрентов',
	'TRACKER_TOP' => 'Топ %d трекера',
	'TRACKER_FORB_PREASON'	=> '-- нельзя скачать',
	'TRACKER_FORB_MREASON'	=> '-- можно скачать',

	'TRACKER_FORB_UREASON'	=> '-- без статуса',
	'TRACKER_RATIO_ANNOT'	=> 'от 0.001',

	'DOWNLOAD_FOR'	=> 'Скачан',

	'TRACKER_USER_YTHANKS' => 'Спасибо от пользователя',
	'TRACKER_USER_TYTHANKS' => 'Спасибо пользователю',

	'TRACKER_GUESTSSESS_LIMIT' => 'Достигнут предел сессий трекера для гостей, попробуйте позже',
	'CHATS_DISABLED' => 'Чаты отключены',
	'CHAT_INDEX_ERROR' => 'Указанный в опции <b>Чат на страницах трекера</b> форум - не является чатом или не существует',
	'CHAT_PORTAL_ERROR' => 'Указанный в опции <b>Чат на странице Портала</b> форум - не является чатом или не существует',
	'CHAT_WINDOW' => 'В всплывающем окне',
	...
	'CLOSE' => 'Закрыть',
	'ONLINE_EXPLAIN_CGP' => 'основано на активности пользователей на',
	...
	'CONVERTER' => 'Конвертер',
	'CONVERTER_EXPLAIN' => 'Конвертер единиц (байт, кб, мб, гб, тб, пб)',
	'SMARTMENUS_TOGGLE' => 'Переключение вида отображения панели',
	...
	'TORRENT_MAGNET_LINK' => 'Магнет ссылка',
	...
	'BROWSING_TOPIC'		=> 'Сейчас эту тему просматривают: %1$s',
	'BROWSING_TOPIC_GUEST'	=> 'Сейчас эту тему просматривают: %1$s и гости: %2$d',
	'BROWSING_TOPIC_GUESTS'	=> 'Сейчас эту тему просматривают: %1$s и гости: %2$d',
	'READING_TOPIC_FULL'				=> 'Просмотр темы "<em>%s</em>" в форуме «%s»',
	...
	'FIRST_POST_SHOW'		=> 'Показывать сообщение на каждой странице темы',
));
