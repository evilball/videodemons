...
$lang = array_merge($lang, array(
	...
	'NO_MERGE_TRACKER_TOPICS'	=> 'Невозможно объединить темы содержащие торрент файлы в форумах-трекерах',
	'NO_MERGE_TRACKER_POSTS'	=> 'Невозможно переместить сообщения в (из) темы содержащие торрент файлы в форумах-трекерах',
	'NO_MOVE_TOPICS_TOCHAT' => 'Невозможно переместить темы в форумы-чаты',
	'NO_MOVE_POSTS_TOCHAT' => 'Невозможно переместить сообщения в форумы-чаты',
	'DISPLAY_FORB' => 'Статус торрента',

	'LOGVIEW_VIEWCHAT'			=> 'Просмотреть чат',
	...
	'report_reasons'		=> array(
		'TITLE'	=> array(
			...
			'OFF_TOPIC'	=> 'Оффтопик',
			'OTHER'		=> 'Другое',
			'TORRENT_ABUSE_CAT' => 'Недопустимая категория торрента',
			'TORRENT_ABUSE_DESCR' => 'Недопустимое описание торрента',
		),
		'DESCRIPTION' => array(
			...
			'TORRENT_ABUSE_CAT' => 'Торрент находится не в той категории или подобные торренты запрещены к выкладыванию',
			'TORRENT_ABUSE_DESCR' => 'Торрент с неполным или неправильным описанием, отсутствует скриншот(ы) и т.д.',
		)
	),
));
