...
$lang = array_merge($lang, array(
	...
	'UNLOCKED'			=> 'Открыт',
	'FORUM_ASTRACKER'						=> 'Является категорией трекера',
	'FORUM_ASTRACKER_EXPLAIN'						=> 'Для форума и ссылки - означает использование как раздела трекера, для категории форума - использование описания как для трекера',
	'FORUM_ASCHAT'						=> 'Является чатом',
	'FORUM_ASCHAT_EXPLAIN'						=> 'Для форума и ссылки - означает использование как чата, для категории форума - использование описания как для чата',
	'FORUM_ASFORUM'						=> 'Является форумом',
	'FORUM_ASFORUM_EXPLAIN'						=> 'Обычный форум',
	'FORUM_ADDFIELDS'						=> 'Дополнительные поля для форума',
	'FORUM_ADDFIELDS_EXPLAIN'						=> 'Отображаются при добавлении нового торрента и/или темы',
	...
	'FORUM_FIRST_POST_SHOW' => 'Первое сообщение темы на всех страницах',
	'FORUM_FIRST_POST_SHOW_EXPLAIN' => '0 - принудительно отключить, 1 - принудительно включить, 2 - отображать в зависимости от опции в сообщении',
));
