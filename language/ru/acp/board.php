...
$lang = array_merge($lang, array(
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'Конференция станет недоступной для посетителей, за исключением администраторов и модераторов. Также вы можете ввести короткое сообщение (до 255 символов), которое будут видеть посетители.',
...
$lang = array_merge($lang, array(
	...
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Путь к папке относительно корневой папки phpBB. Например, <samp>images/avatars/upload</samp>.<br />Загрузка аватар <strong>будет недоступна</strong>, если не разрещена запись в указанную папку.',
...
$lang = array_merge($lang, array(
	'ALLOW_QUICK_REPLY_SMILIES'	=> 'Разрешить смайлики в форме быстрого ответа',
	'ALLOW_QUICK_REPLY_SMILIES_EXPLAIN'	=> 'Если разрешено, панель смайликов будет отображаться в форме быстрого ответа',
	'ALLOW_QUICK_REPLY_BBCODE'	=> 'Разрешить бб-коды в форме быстрого ответа',
	'ALLOW_QUICK_REPLY_BBCODE_EXPLAIN'	=> 'Если разрешено, панель бб-кодов будет отображаться в форме быстрого ответа',
));
