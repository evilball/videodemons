...
$lang = array_merge($lang, array(
	...
	'RESYNC_STATS_EXPLAIN'			=> 'Пересчёт общего количества сообщений, тем, пользователей, торрентов, комментариев и файлов.',
	'RUN'							=> 'Выполнить',
...
$lang = array_merge($lang, array(
	...
	'LOG_RESYNC_STATS'			=> '<strong>Синхронизирована статистика сообщений, тем, торрентов, комментариев и пользователей</strong>',
	...
	'LOG_CONFIG_TRACKER'			=> '<strong>Изменены общие настройки трекера</strong>',
	'LOG_CONFIG_CHAT'			=> '<strong>Изменены общие настройки чата</strong>',
	'LOG_CONFIG_RTRACKER'			=> '<strong>Изменены настройки дополнительных анонс URL</strong>',
	'LOG_CONFIG_TRESTRICTS'			=> '<strong>Изменены настройки ограничений трекера</strong>',
	'LOG_CONFIG_ADDFIELDS'			=> '<strong>Изменены настройки шаблонов дополнительных полей</strong>',
	'LOG_CONFIG_CANDC'			=> '<strong>Изменены настройки обслуживания, удаления и очистки</strong>',
	'LOG_CONFIG_RSS'			=> '<strong>Изменены настройки каналов торрентов и комментариев</strong>',
	'LOG_CONFIG_IMGSET'			=> '<strong>Изменены настройки постеров и скриншотов</strong>',
	'LOG_CONFIG_STATUSES'			=> '<strong>Изменены настройки статусов торрентов</strong>',
	'LOG_CONFIG_GUEST'			=> '<strong>Изменены настройки трекера для гостей</strong>',
	'LOG_CONFIG_RTRACK'			=> '<strong>Изменены настройки внешних анонс URL и мультитрекера</strong>',
	'LOG_CONFIG_GROUPSET'			=> '<strong>Изменены настройки групповых действий</strong>',

	'LOG_CONFIG_ADDFIELD'			=> '<strong>Изменены настройки дополнительных полей</strong>',
	'LOG_CHAT_DELMESS' => '<strong>Удалено сообщение пользователя из чата</strong>',
	'LOG_CHAT_EDITMESS' => '<strong>Отредактировано сообщение пользователя в чате</strong>',
	'LOG_CHAT_UCLEAN' => '<strong>Очищен список пользователей чата</strong>',
	'LOG_CHAT_MCLEAN' => '<strong>Очищен список сообщений чата</strong>',
	'LOG_CHAT_ACLEAN' => '<strong>Очищен список архивных сообщений чата</strong>',
	'LOG_CHAT_UKICK' => '<strong>Удалён пользователь из чата</strong>',
	'LOG_CHAT_UBAN' => '<strong>Забанен пользователь чата</strong>',
	'LOG_CHAT_UUNBAN' => '<strong>Разбанен пользователь чата</strong>',

));

$lang = array_merge($lang, array(
	'ACP_CHAT_SETTINGS'			=> 'Настройки чата',
	'ACP_TRACKER_SETTINGS'			=> 'Настройки трекера',
	'ACP_IMGSET_SETTINGS'			=> 'Настройки постеров и скриншотов',
	'ACP_TRESTRICTS_SETTINGS'			=> 'Ограничения трекера',
	'ACP_RSS_SETTINGS'			=> 'Каналы торрентов и комментариев',
	'ACP_CANDC_SETTINGS'			=> 'Обслуживание, удаление и очистка',
	'ACP_RTRACK_SETTINGS'			=> 'Внешние анонс URL и мультитрекер',
	'ACP_GUEST_SETTINGS'			=> 'Трекер для гостей',
	'ACP_STATUSES_SETTINGS'				=> 'Статусы торрентов',
	'ACP_ADDFIELDS_SETTINGS'				=> 'Шаблоны дополнительных полей',
	'ACP_ADDFIELD_SETTINGS'				=> 'Дополнительные поля',
	'ACP_RTRACKER_SETTINGS'				=> 'Дополнительные анонс URL',
	'ACP_GROUPSET_SETTINGS'				=> 'Групповые действия',

	'ACP_TRACKER'					=> 'Трекер',
	'ADM_PPKBB3CKER_VERSION' => '<b>Трекер</b> - Версия: <strong>%s</strong> Ревизия: <strong>%d</strong> Обновление: <strong>%s</strong>',
	'PPKBB3CKER_NEWREVISION' => 'Ваша ревизия трекера: %d, текущая ревизия трекера: %d',
	'PPKBB3CKER_NEWUPDATE' => 'Ваше обновление трекера: %s, текущее обновление трекера: %s',
	...
	'ACP_ACHEAT_SETTINGS'				=> 'Анализ данных',

	'ACP_DOWNLOADLOG_SETTINGS'			=> 'Лог скачиваний торрент файлов',
	'LOG_CLEAR_DOWNLOADS_DOWNLOADLOG' => '<strong>Очищен лог скачиваний торрент файлов</strong>',
	'ACP_LOSTTORRENTS_SETTINGS'			=> 'Потерянные торренты',
	'LOG_FIX_LOSTTORRENTS' => '<strong>Исправлены потерянные торренты</strong>',
	'LOG_DELETE_LOSTTORRENTS' => '<strong>Удалены потерянные торренты</strong>',
	'LOG_DELETE_TOPICS' => 'Системой автоматического удаления мёртвых торрентов <strong>удалены торренты</strong>',
	));
?>
