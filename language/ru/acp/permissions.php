...
$lang = array_merge($lang, array(
	...
	'ROLE_TRACKER_UPLOADER'			=> 'Роль аплоадера на трекере',
	'ROLE_TRACKER_UPLOADER_DESCR'			=> 'Для аплоадеров трекера',
	'ROLE_TRACKER_VIPUPLOADER'			=> 'Роль VIP аплоадера на трекере',
	'ROLE_TRACKER_VIPUPLOADER_DESCR'			=> 'Для VIP аплоадеров трекера',
	'ROLE_TRACKER_SUPERUPLOADER'			=> 'Роль супер аплоадера на трекере',
	'ROLE_TRACKER_SUPERUPLOADER_DESCR'			=> 'Для супер аплоадеров трекера',
	'ROLE_TRACKER_EXPUPLOADER'			=> 'Роль опытного аплоадера на трекере',
	'ROLE_TRACKER_EXPUPLOADER_DESCR'			=> 'Для опытных аплоадеров трекера',
	'ROLE_TRACKER_TRACKERUSER'			=> 'Роль гостя трекера с возможностью скачивания',
	'ROLE_TRACKER_TRACKERUSER_DESCR'			=> 'Для гостей с возможностью скачивания торрентов',
	'ROLE_TRACKER_TRACKERGUEST'			=> 'Роль гостя трекера без возможности скачивания',
	'ROLE_TRACKER_TRACKERGUEST_DESCR'			=> 'Для гостей без возможности скачивания торрентов',
	'ROLE_TRACKER_LEECHER'			=> 'Роль личера на трекере',
	'ROLE_TRACKER_LEECHER_DESCR'			=> 'Для личеров трекера',
	'ROLE_TRACKER_EXPLEECHER'			=> 'Роль опытного личера на трекере',
	'ROLE_TRACKER_EXPLEECHER_DESCR'			=> 'Для опытных личеров трекера',
	'ROLE_TRACKER_PRIVUSER'			=> 'Роль приватного пользователя на трекере',
	'ROLE_TRACKER_PRIVUSER_DESCR'			=> 'Для категории трекера <b>XXX</b>',
	'ROLE_TRACKER_BLOCKUSER'			=> 'Роль ограниченного пользователя на трекере',
	'ROLE_TRACKER_BLOCKUSER_DESCR'			=> 'Для категории трекера <b>Мусор</b>',
	'ROLE_TRACKER_SUPERMODERATOR'			=> 'Роль супермодератора на трекере',
	'ROLE_TRACKER_SUPERMODERATOR_DESCR'			=> 'Для супермодераторов трекера',
	'ROLE_TRACKER_ADMINISTRATOR'			=> 'Роль администратора на трекере',
	'ROLE_TRACKER_ADMINISTRATOR_DESCR'			=> 'Для администраторов трекера',
	'ROLE_CHAT_USER'			=> 'Роль пользователя чата',
	'ROLE_CHAT_USER_DESCR'			=> 'Для пользователей чата, зарегистрированных пользователей',
	'ROLE_CHAT_GUEST'			=> 'Роль посетителя чата',
	'ROLE_CHAT_GUEST_DESCR'			=> 'Для посетителей чата, незарегистрированных пользователей, с возможностью просмотра и добавления сообщений',
	'ROLE_TRACKER_MODERATOR'			=> 'Роль модератора трекера',
	'ROLE_TRACKER_MODERATOR_DESCR'			=> 'Для модераторов трекера',
	'ROLE_TRACKER_JRMODERATOR'			=> 'Роль младшего модератора трекера',
	'ROLE_TRACKER_JRMODERATOR_DESCR'			=> 'Для младших модераторов трекера',
));
