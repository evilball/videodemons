...
$lang = array_merge($lang, array(
	...
	'REMOTE_UPLOAD_TIMEOUT'		=> 'Файл не может быть загружен из-за превышения времени ожидания ответа сервера на запрос.',
	'SAVE'						=> 'Сохранить',
	...
	'BBCODE_H_HELP'				=> 'Скрытый текст (спойлер): [spoiler]текст[/spoiler] или [spoiler=&quot;Заголовок&quot;]текст[/spoiler]',
	'SPOILER_DEPTH_EXCEEDED'		=> 'Максимально допустимое количество вложенных друг в друга спойлеров в сообщении: %1$d.',
	'BBCODE_FS' => 'Стиль шрифта',
	'BBCODE_FS_HELP' => 'Текст определённым шрифтом: [font=шрифт]текст[/center]',
	'TORRENT_UPLOAD_ERROR'	=> 'Ошибка загрузки торрента, данный торрент уже существует: <b>%s</b>, торрент проверен: <span style="color:#FF0000">%s</span>',
	...
	'CHAT_BOT_MESSAGE' => 'Новый торрент "%s" в форуме "%s"',
	...
	'ADDFIELDS_MULTIHLP' => 'Для выбора более одного значения удерживайте нажатой клавишу <em>Ctrl</em>',
	...
	'ADD_FILEFIELD' => 'Добавить поле',
	'REMOVE_FILEFIELD' => 'Убрать поле',

	'UPLOAD_TORRENT_DISABLED' => 'Страница отключена',
	'UPLOAD_TORRENT_NOAUTH' => 'Нет доступных форумов',
	'PPKBB_MAX_MFU'				=> 'Максимальное количество файлов для одновременной загрузки: <strong>%d</strong>',
));
