...
$lang = array_merge($lang, array(
	...
	'TRACKER_USER_YTHANKS' => 'Ваших спасибо',
	'TRACKER_USER_TYTHANKS' => 'Вам спасибо',
	...
	'USER_TRIGHTS_CLEARED'			=> 'Права на трекере сброшены.',
	'USER_TBONUS_COLLECTED'			=> 'Начисленый бонус за аплоад: %s (исходя из %s)',

	'USER_TPEERS_CLEARED'			=> 'Список раздач очищен',
	'CLEAR_TRIGHTS'				=> 'Сбросить права на трекере',
	'CLEAR_TRIGHTS_EXPLAIN'				=> 'Необходимо только при наличии уже раздаваемых или скачиваемых торрентов, может понадобиться в случае изменений ваших прав на трекере',
	'CLEAR_PEERS'					=> 'Очистить мой список раздач',
	'CLEAR_PEERS_EXPLAIN'			=> 'Удаляет список всех скачиваемых и раздаваемых Вами торрентов',
	'CLEAR_PEERS_TIME'					=> 'Только "мёртвые"',
	'CLEAR_PEERS_ALL'					=> 'Все',
	'COLLECT_TBONUS'				=> 'Начислить бонусы за аплоад',
	'COLLECT_TBONUS_EXPLAIN'				=> 'Начислить бонусы за аплоад на торрентах, значение бонуса будет прибавлено к ратио',

	'TRACKER_USER_PASSKEY' => 'Пасскей',

	'USER_TRATIO_RESET'				=> 'Сбросить значение ратио',
	'USER_TRATIO_RESET_EXPLAIN'				=> 'Значение бонуса при это так же будет сброшено',

	'USER_TBONUS_RESET'				=> 'Сбросить значение бонуса за аплоад',
	'USER_TBONUS_RESET_EXPLAIN'				=> '',

	'USER_TRATIO_RESETTED'				=> 'Значение ратио сброшено',
	'USER_TBONUS_RESETTED'				=> 'Значение бонуса за аплоад сброшено',

	'UCP_MAIN_TORRENTS' => 'Торренты',
	...
	'TORRENT_INFO_HEADER_TOTHANKS'		=> 'Получил спасибо',
	...
	'RTRACK_DISABLED' => 'Система персональных мультитрекеров отключена',
	'RTRACK_SUCCESS' => 'Настройки успешно изменены',

	'INVALID_RTRACK_URL' => 'Некорректный URL трекера',
	'FORB_RTRACK_URL' => 'Запрещённый URL трекера',
	'TRIPREG_COUNTRESTRICT' => 'Регистрация невозможна, максимальное число регистраций с одного IP адреса: <strong>%d</strong>',
	'MAXUSERS_ANNOUNCES_LIMIT' => 'Максимально допустимое количество трекеров: <strong>%d</strong>',
	'UNREGTORR' => 'Незарегистрированные торренты',
	'UNREGTORR_EXPLAIN' => 'На трекере разрешён анонс незарегистрированных (не загруженных на сервер) торрентов, для анонса таких торрентов используйте указанный анонс URL',
	...
	'UTO_PORTAL' => 'Не отображать портал',
	'UTO_PORTAL_EXPLAIN' => 'Не отображать страницу портала',
	'UTO_CHAT' => 'Не отображать чат',
	'UTO_CHAT_EXPLAIN' => 'Не отображать чат на странице портала, страницах списка форумов, тем и сообщений',
	'UTO_TDT' => 'Не отображать топ скачиваемых торрентов',
	'UTO_TDT_EXPLAIN' => 'Не отображать топ скачиваемых торрентов на странице портала, страницах списка форумов и тем',
	'UTO_TDT2' => 'Не отображать новинки трекера',
	'UTO_TDT2_EXPLAIN' => 'Не отображать новинки трекера на странице портала, страницах списка форумов и тем',
));
